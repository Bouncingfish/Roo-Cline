	...
	return (
		<div style={{ marginBottom: "20px" }}>
			...
			<p
				...
				When enabled, Synthience will be able to interact with MCP servers for advanced functionality. If you're
				not using MCP, you can disable this to reduce Synthience's token usage.
			</p>
		</div>
	)
}
