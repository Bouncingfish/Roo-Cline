			...
			<div
				...
				<div style={{ marginBottom: 40 }}>
					...
					<p style={{ fontSize: "12px", marginBottom: 15, color: "var(--vscode-descriptionForeground)" }}>
						The following settings allow Synthience to automatically perform operations without requiring
					...
					<div style={{ marginBottom: 15 }}>
						...
						<p
							...
							When enabled, Synthience will automatically view directory contents and read files without
				...
				<div style={{ marginBottom: 40 }}>
					...
					<div style={{ marginBottom: 15 }}>
						...
						<p
							...
							When enabled, Synthience will play sound effects for notifications and events.
						</p>
					</div>
					{soundEnabled && (
				...
				<div style={{ marginBottom: 40 }}>
					...
					<div style={{ marginBottom: 15 }}>
						...
						<p
							...
							When enabled, Synthience will be able to edit files more quickly and will automatically
				...
				<div
					...
					<p style={{ wordWrap: "break-word", margin: 0, padding: 0 }}>
						...
						<VSCodeLink href="https://github.com/Synthience/Synthience" style={{ display: "inline" }}>
							github.com/Synthience/Synthience
						</VSCodeLink>{" "}
						or join{" "}
						<VSCodeLink href="https://www.reddit.com/r/Synthience/" style={{ display: "inline" }}>
							reddit.com/r/Synthience
						</VSCodeLink>
					</p>
