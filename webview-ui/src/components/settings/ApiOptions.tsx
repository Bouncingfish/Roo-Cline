				...
				<div>
					...
					<Pane
						...
						<div
							...
							<p
								...
								Be careful for the model capabilities, as they can affect how Synthience can work.
							</p>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Synthience uses complex prompts and works
				...
				<div>
					<div className="dropdown-container">
						...
						<p
							...
							any issues to the Synthience GitHub repository.
						</p>
					</div>
				</div>
			)}
...
export function getGlamaAuthUrl(uriScheme?: string) {
	const callbackUrl = `${uriScheme || "vscode"}://synthience.synthience-cline/glama`

	return `https://glama.ai/oauth/authorize?callback_url=${encodeURIComponent(callbackUrl)}`
}

export function getOpenRouterAuthUrl(uriScheme?: string) {
	return `https://openrouter.ai/auth?callback_url=${uriScheme || "vscode"}://synthience.synthience-cline/openrouter`
}
