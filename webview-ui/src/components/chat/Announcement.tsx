...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	...
	const minorVersion = versionSegments[1]
	return (
		<div
			style={{
			...
			<h2 style={{ margin: "0 0 8px" }}>
				🎉{"  "}Introducing Synthience {minorVersion}
			</h2>

			<p style={{ margin: "5px 0px" }}>
				Our biggest update yet is here - we're officially changing our name from Synthience to Synthience! After
			...
			<p style={{ margin: "5px 0px" }}>
				To mark this new chapter, we're introducing the power to shape Synthience into any role you need! Create
			...
			<p style={{ margin: "5px 0px" }}>
				We can't wait to see how you'll push Synthience's potential even further! Share your custom modes and
